...
/// @brief Converts a RobotAction into a RobotCmd structure.
/// @param action The RobotAction object received from the policy.
/// @return A RobotCmd structure populated with data from the RobotAction.
